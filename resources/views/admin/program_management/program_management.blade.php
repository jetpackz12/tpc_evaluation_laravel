                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex justify-content-center align-items-center">
                                                    <button class="btn btn-primary mr-1 editWithData"
                                                        data-id="{{ $program->id }}" data-toggle="modal"
                                                    ...
                                                    @if ($program->status == 1)
                                                        <button class="btn btn-danger editStatus"
                                                            data-id="{{ $program->id }}"
                                                            data-status="{{ $program->status }}" data-toggle="modal"
    ...
    <div class="modal fade" id="modal-add">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('program_management_store') }}" method="POST" class="postForm">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="exampleInputProgramCode"
                                        name="program_code" placeholder="Enter Program Code" min="1000" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="exampleInputProgramName">Program Name</label>
                                    <input type="text" class="form-control" id="exampleInputProgramName"
                                        name="program_name" placeholder="Enter Program Name" required>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('program_management_update') }}" method="POST" class="postForm">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <input type="text" class="form-control" id="e_id" name="id" hidden>
                            <input type="text" class="form-control" id="e_old_program_code"
                                name="old_program_code" hidden>
                            <div class="col-12">
                                <div class="form-group">
                                    <label for="program_code">Program Code</label>
                                    <input type="number" class="form-control" id="e_program_code"
                                        name="program_code" placeholder="Enter Program Code" min="1000" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="e_program_name"
                                        name="program_name" placeholder="Enter Program Name" required>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modal-delete">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form action="{{ route('program_management_status') }}" method="POST" class="postForm">
                    @csrf
                    <div class="modal-body">
    ...
    <script>
        ...
        $(document).ready(function() {
            $('.editWithData').on('click', function() {
                const path = "{{ route('program_management_edit') }}";
